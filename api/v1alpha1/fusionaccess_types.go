...
// +kubebuilder:validation:Enum=v5.2.3.0.1;v5.2.3.0.dummy;v5.2.3.1.dev3
...
type FusionAccessSpec struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="IBM Storage Scale Version",order=2,xDescriptors={"urn:alm:descriptor:com.tectonic.ui:select:v5.2.3.0.1","urn:alm:descriptor:com.tectonic.ui:select:v5.2.3.0.dummy","urn:alm:descriptor:com.tectonic.ui:select:v5.2.3.1.dev3"}
